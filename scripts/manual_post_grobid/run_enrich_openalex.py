...
from osf_sync.augmentation.doi_check_openalex import enrich_missing_with_openalex
from osf_sync.logging_setup import get_logger


log = get_logger("scripts.enrich_openalex")
...
def main() -> None:
    ...
    log.info("OpenAlex enrichment finished", extra=stats)
